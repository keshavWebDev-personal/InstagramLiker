<script lang="ts">
  ...
  function openLinks() {
    const links = [
      "https://www.instagram.com/honeypreet_insan/",
      "https://www.instagram.com/msgthefilm/",
      "https://www.instagram.com/msgmyandurchoice/",
      "https://www.instagram.com/sevenwondersresort/",
      "https://www.instagram.com/ayurvedapma/",
      "https://www.instagram.com/shahsatnamjigreens/",
      "https://www.instagram.com/sachkahoon/",
      "https://www.instagram.com/saintdrmsginsan/",
...
<main
  class=" relative px-5.5 py-5.5 bg-gradient-to-r from-[#3A3647] to-[#624F4F] w-full h-full font-sans flex flex-col"
>
  ...
  <div
    class=" mt-4 px-3 py-2 h-22 flex bg-gradient-to-r from-[#3E446B] to-[#A67792] w-full rounded-2xl flex-col justify-between *:leading-none"
  >
    <div class="text-[0.7rem] text-gray-300">Status</div>
    <div
      class="text-4xl -mt-1 font-bold"
